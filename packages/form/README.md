...
| **続く約1週間** | 技術寄りの設計。`hub` との揃え方・責務の境界を議論する。フレームワークや API の細部は、方針が見えてからにする | 「hub との揃えについて」 |
...
**揃える論点（未決）。揃え方・責務の境界は議論する。フレームワークや API の細部は、方針が見えてからにする。**
...
あわせて、**共創プラットフォーム**（デジタル庁まわりの自治体職員向けコミュニティ。公開の Slack チャンネル）でも呼びかける。そこでの議論は GitHub を開かない人向けの入口であり、**すべてを共創PFに限るわけではない。**

- 共創PFの **公開チャンネル** に出た内容は、個人名・自治体名を伏せて Issue に転載する（属性のみ）
- **鍵付きチャンネルと DM** の内容は転載しない

Issue では、現場の話は「窓口の流れについて」、hub とのつなぎの話は「hub との揃えについて」の下にコメントしてほしい（できればでよい）。

### 誰に聞きたいか

| 誰 | 第1段 |
|---|---|
| 現役の窓口担当 | **主役。** 現場の流れと判断だけでよい。共創PFでも Issue でも可 |
| 窓口に詳しい元SE（職員） | 壊してはいけない操作、`hub` 連携で困る分岐 |
| エンジニア・コントリビューター | 質問・確認・補足は歓迎。いまの主役は窓口の流れ。方向が見えたあとの小さなコード提案も歓迎 |
